        ...
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="text-align : right;">
                    <span >
                        <a href="{{ url('/voyages')}}" class="btn btn-outline-primary">
                            <img src="assets/images/imprime.jpg" class="user-avatar-md rounded-circle" />&nbsp;&nbsp;&nbsp;Imprimer
                        </a>
                    </span>
                </div>
            </div>
